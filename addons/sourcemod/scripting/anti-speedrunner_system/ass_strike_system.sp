...
{
	if (!g_cvASSEnable.BoolValue || !g_cvASSStrikeEnable.BoolValue || flGetSurvivorCount() < 3 || (!g_cvASSTankAlive.BoolValue && iGetTankCount() > 0) || (g_cvASSNoFinales.BoolValue && bIsFinaleMap()) || !bIsSystemValid(g_cvASSGameMode, g_cvASSEnabledGameModes, g_cvASSDisabledGameModes, g_cvASSGameModeTypes))
	{
