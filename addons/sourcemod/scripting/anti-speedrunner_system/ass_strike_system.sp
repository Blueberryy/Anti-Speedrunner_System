...
void vStrikeCvars()
{
	g_cvASSStrikeDelay = ASS_ConVar("assstrike_detectiondelay", "5.0", "How often does the Strike system check for speedrunners?", _, true, 1.0, true, 99999.0);
